  ...
  return (
    <>
      <div className="flex flex-col ">
        <div className="flex flex-row items-center justify-between px-40">
          ...
          <div className="relative w-80 h-80 bg-gray-300">
            <Image src="/imgs/head.jpg" layout="fill" objectFit="cover" />
          </div>
          <div className="flex-none min-w-60">
            <SampleIntroduction
      ...
      <div className="flex items-center justify-center p-1 mt-5">
        <Entry color={"green"} section={"About"} />
      </div>
      <div className="flex items-center justify-evenly p-1">
        <Entry className="felx-auto" color={"purple"} section={"Project"} />
        <Entry className="felx-auto" color={"blue"} section={"Skill"} />
      </div>
      <div className="flex items-center justify-between p-1">
        <Entry className="felx-auto" color={"yellow"} section={"Bookshelf"} />
        <Entry className="felx-auto" color={"red"} section={"Idea"} />
      </div>
    </>
  );
}
